...
urlpatterns = [
    ...
    path('product/admin/', ProductListCreateView.as_view(), name='admin_product_create_list'),
    # This URL is used for product retrieve, partially or fully update and delete
    path('product/admin/<int:pk>/', ProductUpdateDeleteDestroyView.as_view(),
         name='admin_product_retrieve_update_delete'),
]